...
include '../inc/logics/genders.php';
?>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card border-0 shadow-lg">
                                <div class="card-header border-0">
                                    <h6 class="card-title d-inline">Add Gender</h6>
                                ...
                                <div class="card-body">
                                    <form action="" method="post">
                                        <div class="add-gender">
                                            ...
                                            <div class="my-4">
                                                <button type="submit" name="addGender" class="btn btn-md btn-success text-white w-100">Add</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div class="card-body">
                                    <form action="" method="post">
                                        <div class="edit-gender">
                                            ...
                                            <div class="my-4">
                                                <button type="submit" name="updateGender" class="btn btn-md btn-primary text-white">Update</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
